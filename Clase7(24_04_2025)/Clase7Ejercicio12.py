...
##Escribe un programa que pida al usuario una serie de números enteros y
##determine cuál es el mayor y cuál es el menor.
...
while numero !=0:
    ...
    numero = int(input("Introcude un valor (0 para terminar): "))
